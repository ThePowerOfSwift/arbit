    ...
    <div class="row rowDataBot2 margin_Top_50">
        <div class="col-md-4 textAlignCenter height220">
            ...
            <div class="third_wDiv">
                <button class="btn btn-warning btn-blockDash" id="shade" onclick="withDrawArb()">Withdraw ARB</button>    
            </div>
        </div>
        ...
        <div class="col-md-4 textAlignCenter height220">
            ...
            <div class="row third_wDiv">
                <div class="col-lg-6 col-md-12">
                    <button class="btn btn-warning btn-blockDash" id="" onclick="withDrawEth()">Withdraw ETH</button>
                </div>
                <div class="col-lg-6 col-md-12">
                    <button class="btn btn-warning btn-blockDash" id="" onclick="sendEthToAbot()">Send ETH to aBOT</button>
                </div>
            </div>
        </div>
        <div class="col-md-4 textAlignCenter height220">
            ...
            <div class="third_wDiv">
                <button class="btn btn-warning btn-blockDash" id="shade" onclick="withDrawExternalArbCheck()">Withdraw External ARB</button>    
            </div>
        </div>
    </div>
    ...
    <div class="row poolTableDiv height220">
        ...
        <div class="col-md-4">
            <div>
                ...
                <div class="">
                    <span class="lgFontBOT2">Free ARB</span>     
                </div>
            </div>    
        ...
        <div class="modal-content" style="font-size:12px">
            ...
            <div class="modal-body pb-5">
                ...
                <div class="col-md-12 pt-4">
                    ...
                    <br>
                    <span class="text-danger" style="font-size:13px">0.5 ARB as fee will deduct in every ARB withdrawal. </span>
                </div>
            </div>
        ...
        <div class="modal-content" style="font-size:12px">
            ...
            <div class="modal-body pb-5">
                ...
                <div class="col-md-12 pt-4">
                    ...
                    <br>
                    <span class="text-danger" style="font-size:13px">0.0015 ETH as fee will deduct in every ETH withdrawal. </span>
                </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="poolToSystemArbModal">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" style="font-size:12px">
            <div class="modal-header modalHeaderExchange">
                <h5 class="modal-title">This will Transfer your Free ARB from Pool to System.</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    function sendEth (){
        ...
        else if (page == "abot")
        {
           if(confirm("Do you want to transfer your amount?"))
            ...
            $('#error_Modal').modal('show');
            $("#withdrawError").text("Selecte Some Option");
        }
    }
