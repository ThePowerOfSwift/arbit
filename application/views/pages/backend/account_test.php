...
<div class="container-fluid" style="background: #f7f7f7;">
    <div class="row">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <? }?>
          <li class="nav-item">
            <a class="nav-link " id="auction-tab" data-toggle="tab" href="#autionTAB" role="tab" aria-controls="autionTAB" aria-selected="true">Auction Bids</a>
          </li>
        </ul>
...
slow hours when volume needs assistance, returning you this fee overtime.)</strong></span>
          ...
          <!--  -->
          <div class="tab-pane fade" id="autionTAB" role="tabpanel" aria-labelledby="autionTAB">
            <div class="col-md-12 pt-3 pb-3">
                <div class="card">
                    <div class="card-header">
                         <i class="fa fa-poll"></i> Auction Bids
                    </div>
                    <div class="card-body votingTab">
