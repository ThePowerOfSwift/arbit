...
class poloniex {
	...
	public function get_my_trade_history($pair = 'ALL') {
			return $this->query(
					array(
	...
	public function withdraw($currency, $amount, $address, $tag = null) {
			...
			if($tag){$prm['paymentId'] = $tag;}
			return $this->query($prm);
	}
	...
	public function generateDepositAddress($currency) {
			return $this->query(
					array(
	...
	public function returnOrderTrades($orderId){
	    return $this->query(
					array(
