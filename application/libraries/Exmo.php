...
class Exmo
{
	...
	public function place_order ($type, $symbol, $quantity, $price = 0){
		$params = array(
            'pair'=> $symbol,
            'quantity'=> $quantity,
            'price' => $price,
	...
	public function open_orders(){
	    return $this->call('user_open_orders');
	}
	
	public function close_orders($pair){
	    $params = array(
            'pair'=> $pair
        );
	...
	public function cancel_order($id){
	    ...
	    return $this->call('order_cancel', $params);
	}
