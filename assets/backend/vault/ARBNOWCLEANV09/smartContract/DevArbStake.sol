...
contract DEVTokenDEVT is ERC20Interface,OwnableDev {
   ...
   string public constant symbol = "DEVT";
   ...
   event Debug(string message, address addr, uint256 number);
    ...
    function DEVToken(address wallet) public {
        owner = 0x36EA59b8657bab4de6147a1B065033DC46008650;
        ownerWallet=wallet;
  ...
  */
  function balanceOf(address _owner) constant public returns (uint256 balance) {
    ...
    function setStakingAddress(address stakingAddr) public onlyOwner{
      require(stakingAddress == address(0x0));
