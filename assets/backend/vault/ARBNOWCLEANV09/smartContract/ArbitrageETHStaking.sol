...
contract ArbitrageETHStaking is Ownable {
    ...
    // @dev Buy in staking pool, transfer ethereum in the contract, pay 1% fee
    function buy()
        public
        payable
    {
        ...
        if (_etherBeforeBuyIn != 0) {
            ...
            // Add 1% fee of the buy to the staking pool
