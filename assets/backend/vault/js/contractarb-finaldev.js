...
var contractAddress = '0x57f1525a868e5B9856b5Ea58B65B66C49E97ecdA' // // THIS CONTRACT IS FOR THE ARB ONLY - THE LEFT SIDE -
...
window.addEventListener('load', function() {
    ...
    // Withdraw Some arb click handler - DEV // //
    ...
    $('#copy-arb-address').click(function(e) {
        e.preventDefault()
        copyToClipboard(currentAddress)

        $('#copy-arb-address').popup({
            content: lang.copiedToClip,
            hoverable: true
        }).popup('show')

    }).on('mouseout', function() {
        $('#copy-arb-address').popup('destroy')
    })
})
